...
FunctionHelper.prototype.date_diff = function(date, compareDate, diffType, noQuotes, noQuotesCompare, alias) {  
  return this.client.raw("(DATEDIFF("+diffType.toLowerCase()+", "+FunctionHelper.prototype.getDateForQFn(compareDate, noQuotesCompare)+", "+FunctionHelper.prototype.getDateForQFn(date, noQuotes)+"))"+FunctionHelper.prototype.addAliasToQFn(alias));
}
