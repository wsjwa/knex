...
FunctionHelper.prototype.day = function(date, noQuotes, alias) {
  ...
  return this.client.raw("EXTRACT(DAY FROM "+date+")"+FunctionHelper.prototype.addAlias(alias));
}
...
FunctionHelper.prototype.month = function(date, noQuotes, alias) {
  ...
  return this.client.raw("EXTRACT(MONTH FROM "+date+")"+FunctionHelper.prototype.addAlias(alias));
}
...
FunctionHelper.prototype.year = function(date, noQuotes, alias) {
  ...
  return this.client.raw("EXTRACT(YEAR FROM "+date+")"+FunctionHelper.prototype.addAlias(alias));
}
